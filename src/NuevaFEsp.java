 ...
 * @author ricardoi
 */
public class NuevaFEsp extends javax.swing.JInternalFrame  implements TableModelListener {
...
this.add(datePicker);
    ...
    private void iniciarData(){
        ...
        jTextField2.setText(opciones.get("fesp_resolucion"));
        jTextField3.setText(opciones.get("fesp_serie"));
        jTextField1.setText(opciones.get("fesp_actual"));
...
datePicker.setBounds(215, 82, 150, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String respuesta = APIGeface.enviarDataFEsp(params,ArrDatos);
        String archivo = Registro.procesaArchivo(respuesta);
        if((archivo!="")&&(!archivo.startsWith("error"))){ 
            int correlativo = Integer.valueOf(opciones.get("fesp_actual"));
            int maximo = Integer.valueOf(opciones.get("fesp_final"));
            if(correlativo<maximo){
                opciones.put("fesp_actual", String.valueOf(correlativo+1));
